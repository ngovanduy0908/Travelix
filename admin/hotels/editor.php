<?php
    ...
    $id = $place_title = $name = $price = $thumbnail = $description = $created_at = $updated_at = $rating = '';
    require_once('form_save.php');
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $sql = "SELECT hotel.*, places.title as place_title from places, hotel where hotel.place_id = places.id and hotel.id = $id";
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input required="true" type="text" class="form-control" id="place_title" name="place_title" value="<?=$place_title?>" readonly>
                                </div>
                            </div>
                        </div>
