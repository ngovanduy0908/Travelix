                        ...
                        <tbody>
                            <?php
                                if(isset($_POST['search'])){
                                    ...
                                    $sql = "SELECT hotel.*, places.title as place_title from places, hotel where hotel.place_id = places.id and places.title like '%$title%'";
                                    ...
                                    $sql = "select count(id) as count_id from hotel";
                                    ...
                                    $sql = "SELECT hotel.*, places.title as place_title from places, hotel where hotel.place_id = places.id order by updated_at desc limit $start,$limit";
                                    $hotelList = $connect->query($sql);
                                    if($hotelList->num_rows > 0){
                                        $index = 0;
                                        while($row = $hotelList->fetch_assoc()){
                                            // var_dump($row['username']);
                                            echo '<tr>
                                            <th>'.(++$start).'</th>
                                            <td>'.$row['name'].'</td>
