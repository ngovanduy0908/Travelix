    ...
    <div class="main">
        <nav class="main_nav">
            <div class="row">
                ...
                <div class="col-md-4">
                    <h1 style="text-align: center">Manager Feedback</h1>
                </div>
                <div class="col-md-4">
        ...
        <div class="main_body">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <span style="width: 600px; display:inline-block; float: right; margin: 20px 50px 10px 0">
                        <form action="" method="post" class="feedback-form">
                            ...
                            <div class="form-group">
                                <label for="choseYes">Lọc phản hồi đã đọc</label>
                                <input type="radio" name="checkStatus" id="choseYes" value="yes">
                            </div>

                            <div class="form-group">
                                <label for="choseNo">Lọc phản hồi đã chưa đọc</label>
                            ...
                            $msg = "";
                                if(isset($_POST['search'])){
                                    ...
                                    if(isset($_POST['checkStatus']) && $_POST['checkStatus'] == 'yes'){ 
                                        $sql = "SELECT feedback.*, users.fullname as fullnameUser, users.email as emailUser, users.phone_number as phoneUser from feedback, users where users.id = feedback.user_id and status = 1";
                                    }

                                    if(isset($_POST['checkStatus']) && $_POST['checkStatus'] == 'no'){ 
                                        $sql = "SELECT feedback.*, users.fullname as fullnameUser, users.email as emailUser, users.phone_number as phoneUser from feedback, users where users.id = feedback.user_id and status = 0";
                                    }
                                    ...
                                    $msg = "";
                                    $sql = "SELECT feedback.*, users.fullname as fullnameUser, users.email as emailUser, users.phone_number as phoneUser from feedback, users where users.id = feedback.user_id order by status asc, created_at desc";
                    ...
                    <a href="delete.php"><button class="btn btn-danger">Xóa Tất Cả</button></a>
