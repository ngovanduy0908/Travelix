...
// contactContent.onscroll = function () {
//     console.log(contactContent.scrollTop)
// }
...
contactTextarea.onkeyup = function (e) {
    ...
    if(e.which == 13) {
        ...
        console.log(`Vị trí trước của thanh cuộn ${contactContent.scrollTop}`)
        console.log(`Độ cao thực sự của phần tử ${contactContent.scrollHeight}`)
        console.log(`Độ cao của phần tử ta css ${contactContent.clientHeight}`)
        // console.log(`Vị trí mà thanh cuộn nên đứng ${contactContent.scrollHeight - contactContent.clientHeight}`)

        // if(isScrolledToBottom) {
            contactContent.scrollTop = contactContent.scrollHeight - contactContent.clientHeight
        // }
        console.log(`Vị trí sau của thanh cuộn ${contactContent.scrollTop}`)
